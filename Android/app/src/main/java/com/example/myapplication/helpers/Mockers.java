...
public class Mockers {
    ...
    public List<ProblemModel> mockMarkersList(){
        ...
        problemsList.add(new ProblemModel(1, new LatLng(45.7518239, 21.2221786), "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "12-07-2020", photoList, false));
        problemsList.add(new ProblemModel(2, new LatLng(45.7528239, 21.2321786), "Lorem Ipsum is simply dummy texty's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "14-05-2020", photoList, true));
        problemsList.add(new ProblemModel(3, new LatLng(45.7498239, 21.2341786), "Lorem Ipsum is simply dummy text of  dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "16-12-2020", photoList, true));
        problemsList.add(new ProblemModel(4, new LatLng(45.7538239, 21.2431786), "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "17-01-2020", photoList, false));
        problemsList.add(new ProblemModel(5, new LatLng(45.7508239, 21.2431786), "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "13-06-2020", photoList, false));
        problemsList.add(new ProblemModel(6, new LatLng(45.7508239, 21.2451786), "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standar", "23-04-2020", photoList, true));
